-- DROP IF EXISTS TABLE Ligne;
-- DROP IF EXISTS TABLE Commande;
-- DROP IF EXISTS TABLE Produit;
-- DROP IF EXISTS TABLE Client;
-- DROP IF EXISTS TABLE Categorie;


CREATE TABLE Categorie (
    Code INT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
